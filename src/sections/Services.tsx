...
const services: Service[] = [
  ...
  },
  {
    num: '03',
    name: 'Energia Solar',
    desc: 'Panells fotovoltaics i autoconsum per reduir la teva factura energètica.',
    image: '/images/service-3.jpg',
    detall: 'Som especialistes en instal·lació de plaques solars fotovoltaiques per a autoconsum, tant per a particulars com per a empreses. Gestionem tots els tràmits administratius i t\'assessorem sobre les subvencions disponibles.',
    punts: [
      'Instal·lació de plaques fotovoltaiques',
      'Sistemes d\'emmagatzematge amb bateries',
      'Tramitació de llicències i subvencions',
      'Monitoratge en temps real de la producció',
      'Rendibilitat garantida en menys de 7 anys',
    ],
  },
  {
    num: '04',
  ...
  },
  {
    num: '05',
    name: 'Domòtica',
    desc: 'Automatització intel·ligent de la llar per a confort, seguretat i estalvi.',
    image: '/images/service-5.jpg',
    detall: 'Convertim la teva llar o oficina en un espai intel·ligent. Integrem sistemes de control d\'il·luminació, climatització, persianes i seguretat en una única plataforma que pots gestionar des del mòbil o per veu.',
    punts: [
      'Sistemes KNX, Zigbee i Z-Wave',
      'Control des de smartphone o tauleta',
      'Integració amb Alexa, Google i Siri',
      'Programació d\'escenes i rutines',
      'Estalvi energètic de fins al 30%',
    ],
  },
  {
    num: '06',
    name: 'Videovigilància',
    desc: 'Sistemes de càmeres i control d\'accessos per protegir la teva propietat.',
    image: '/images/service-6.jpg',
    detall: 'Dissenyem i instal·lem sistemes de seguretat a mida per a habitatges, locals i empreses. Càmeres IP d\'alta resolució, enregistrament en núvol i control d\'accessos per garantir la tranquil·litat les 24 hores.',
    punts: [
      'Càmeres IP Full HD i 4K',
      'Enregistrament local i en núvol',
      'Alarmes perimetrals i sensors de moviment',
      'Control d\'accés amb targeta o empremta',
      'Visualització remota des del mòbil',
    ],
  },
]
